 ...
 * títulos de sección ni textos explicativos. Las tarjetas van sin descripción a
 * propósito — el título y el propio gráfico tienen que bastar; si un bloque
 * necesita un párrafo para entenderse, el problema es el bloque.
 *
  ...
  return (
    <div className="mx-auto w-full max-w-[1440px]">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 xl:grid-cols-12 xl:gap-5">
        {/* ---------- A · Cifras principales, a ancho completo ---------- */}
        <section
        ...
        {/* ---------- B · Ingresos del mes (ancla de la página) ---------- */}
        <TarjetaIngresos
        ...
        {/* ---------- C · Reparto por plan ----------
            Al lado del héroe a propósito: el héroe dice CUÁNTO se facturó y
            esta tarjeta, DE QUÉ se compone esa misma cifra. */}
        <ChartCard
        ...
        {/* ---------- D · Tasa de renovación ----------
            Segunda tarjeta oscura: parte el bloque de blancas y da ritmo. */}
        <Card
          tono="oscuro"
          fx
